 ...
 * File format:
 * 
 * id label, label, label, ... //vertices int int, int int, ... //edges
 * 
 * id label, ... int int, ...
 * 
 * 
...
public class LGraphFile {
	...
	public static LGraph[] loadLGraphs(String filename) throws IOException {
		...
		while (true) {
			...
			for (int i = 0; i < m; i++) {
				...
				if (tokens.hasMoreTokens()) {
					...
					edges[i] = new UnlabeledEdge(v1, v2, w, false);
				}
				else
	 ...
	 *            String
	 */
	public static void saveLGraphs(LGraph[] graphs, String filename)
			throws IOException {
